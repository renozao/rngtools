...
\title{\texttt{rngtools}: Unit testing results\footnote{Vignette computed  on Wed Oct 31 16:19:08 2012}}
\date{\texttt{rngtools} version 1.0 as of October 31, 2012}
\usepackage{Sweave}
\begin{document}
\maketitle

\begin{verbatim}
RUNIT TEST PROTOCOL -- Wed Oct 31 16:19:08 2012 
*********************************************** 

...
\title{\texttt{rngtools}: Unit testing results\footnote{Vignette computed  on Sat Nov  3 00:38:37 2012}}
\date{\texttt{rngtools} version 1.0 as of November  3, 2012}
\usepackage{Sweave}
\begin{document}
\maketitle

\begin{verbatim}
RUNIT TEST PROTOCOL -- Sat Nov  3 00:38:37 2012 
*********************************************** 
...
\begin{itemize}\raggedright
  ...
  \item Other packages: codetools~0.2-8, digest~0.5.2, pkgmaker~0.8.19,
    rngtools~1.0, RUnit~0.4.26, stringr~0.6

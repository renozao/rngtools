...
\title{\texttt{rngtools}: Unit testing results\footnote{Vignette computed  on Mon Nov  5 11:13:41 2012}}
\date{\texttt{rngtools} version 1.0 as of November  5, 2012}
\usepackage{Sweave}
\begin{document}
\maketitle

\begin{verbatim}
RUNIT TEST PROTOCOL -- Mon Nov  5 11:13:40 2012 
*********************************************** 
